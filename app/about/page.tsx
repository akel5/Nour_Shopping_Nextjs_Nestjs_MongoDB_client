    ...
    <div className="min-h-screen" dir="ltr">
      <div className="container mx-auto max-w-4xl py-16 px-6 text-left">
        ...
        <section className="mb-16">
          {/* שינוי ל-text-black לנראות מקסימלית */}
          <h1 className="font-serif text-5xl font-bold text-black mb-6 text-center">
            About NOR
          </h1>
          {/* שינוי ל-text-gray-900 (כהה יותר מ-700) לקריאות משופרת */}
        ...
        <section>
          {/* שינוי ל-text-black */}
          <h2 className="font-serif text-4xl font-bold text-black mb-6 text-center">
            Get in Touch
          </h2>
          {/* שינוי ל-text-gray-900 */}
          ...
          <div className="bg-white p-8 rounded-lg shadow-md max-w-lg mx-auto border border-gray-200">
            <div className="flex items-center mb-4">
              {/* החלק הזה נשאר ללא שינוי (מצויין) */}
